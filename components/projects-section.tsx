...
const projects: Project[] = [
  {
    title: "Mediconnect",
    description:
      "Full-stack medicine management & reminder web app with Supabase backend. Features medicine tracking, expiry alerts, and interactive dashboard.",
    tags: ["React", "Next.js", "Supabase", "Tailwind CSS"],
    github: "https://github.com",
    live: "https://mediconnect.demo",
    icon: "💊",
  },
  {
