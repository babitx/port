...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-gradient-to-b from-background via-background/95 to-background/80">
          ...
          <motion.div variants={itemVariants} className="mb-8 relative">
            <div className="relative inline-block">
              ...
              <div className="relative w-32 h-32 rounded-full overflow-hidden border-2 border-neon-cyan/50 shadow-lg glow">
                <img src="/developer-profile-picture.jpg" alt="Babit Kumar" className="w-full h-full object-cover" />
              </div>
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex gap-4 justify-center flex-wrap">
            ...
            <button
              onClick={() => {
                ...
                link.href = "/Babit-Kumar-Resume.pdf"
                link.download = "Babit-Kumar-Resume.pdf"
